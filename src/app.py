...
def signup_for_activity(activity_name: str, email: str, user: dict = Depends(require_auth)):
...
def unregister_from_activity(activity_name: str, email: str, user: dict = Depends(require_auth)):
